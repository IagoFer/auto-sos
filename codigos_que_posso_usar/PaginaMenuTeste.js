...
const PaginaMenuTeste = () => {
  const [empresas, setEmpresas] = useState([
    { id: '1', nome: 'Empresa 1', localizacao: 'Rua A, Cidade X', horario: '9:00 - 18:00' },
    { id: '2', nome: 'Empresa 2', localizacao: 'Rua B, Cidade Y', horario: '10:00 - 19:00' },
  ...
  const renderCard = ({ item }) => {
    return (
      <TouchableOpacity style={styles.card} onPress={() => entrarNoPerfil(item)}>
        ...
        <Text style={styles.info}>{item.localizacao}</Text>
...
export default PaginaMenuTeste;