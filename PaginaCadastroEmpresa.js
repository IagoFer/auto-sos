...
const PaginaCadastroEmpresa = ({ navigation }) => {
        ...
        fetch("http://206.189.181.153:8080/sosAuto/companies", {
            ...
            .then(data => {
                ...
                if (data.status == 204) {
                    ...
                    throw new Error(data.error || 'Erro durante o cadastro. Por favor, tente novamente.');
                }
            })
            .catch(error => {
                console.error('Erro durante a solicitação:', error);
                alert(error.message || 'Erro durante a solicitação. Por favor, tente novamente.');
            });
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <TextInput placeholder="Nome" value={nome} style={styles.input} placeholderTextColor="#ccc" onChangeText={setNome} />
            <TextInput placeholder="Email" value={email} style={styles.input} placeholderTextColor="#ccc" onChangeText={setEmail} />
            <TextInput placeholder="Cnpj" value={cnpj} style={styles.input} placeholderTextColor="#ccc" onChangeText={setCnpj} />
            <TextInput placeholder="Telefone" value={numero} style={styles.input} placeholderTextColor="#ccc" onChangeText={setNumero} />
            <TextInput placeholder="Endereço" value={endereco} style={styles.input} placeholderTextColor="#ccc" onChangeText={setEndereco} />
            <TextInput placeholder="Senha" value={senha} secureTextEntry={true} style={styles.input} placeholderTextColor="#ccc" onChangeText={setSenha} />
            <Picker selectedValue={diasDeTrabalho} onValueChange={(itemValue) => setDiasDeTrabalho(itemValue)} style={styles.picker} >
